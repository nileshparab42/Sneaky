...
public class LoginScreen extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks {
    ...
    String SITE_KEY = "6LfUANYmAAAAACZ6sGe0niOtMdZB1TbUyIwtNs3Q";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signbtn = findViewById(R.id.noac);

        signbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iLog = new Intent(LoginScreen.this,SignupScreen.class);
                iLog.setFlags(iLog.FLAG_ACTIVITY_CLEAR_TASK|iLog.FLAG_ACTIVITY_NEW_TASK);
                startActivity(iLog);
            }
        });
